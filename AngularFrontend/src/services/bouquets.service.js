...
angular.module('cannis.services.bouquets', ['ngResource'])
    .factory('bouquetApiService', function($resource, $filter, endPointConstant){
        return $resource(
            endPointConstant.apiUrls.bouquet,
            {

            },
            {
                getBouquet:{
                    url: endPointConstant.apiUrls.bouquet,
                    method: 'GET'
                },
                addBouquet: {
                    url: endPointConstant.apiUrls.bouquet+"?_method=PUT",
                    method: 'POST',
